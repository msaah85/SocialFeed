<%@ Page Title="Cities" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" EnableTheming="false" EnableViewState="false" ViewStateMode="Disabled" EnableSessionState="ReadOnly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <form class="form-horizontal" role="form" id="aspnetForm">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right">City name <span class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="col-sm-10 required" required id="CityName" name="CityName" placeholder="City name" />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script src="/Scripts/sys/citiesManager.min.js"></script>
</asp:Content>